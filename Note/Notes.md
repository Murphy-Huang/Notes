...
13. 字符串比较一般情况下，建议调用不依赖于默认设置的方法，因为这会明确代码的意图。这进而使代码更具可读性且更易于调试和维护。StringComparison.CurrentCulture/InvariantCulture/Ordinal。<https://blog.csdn.net/dark_tone/article/details/101808816>
14. 适当使用弃元"_"减少内存的分配，例：swithc、out、元组、函数无用返回值
